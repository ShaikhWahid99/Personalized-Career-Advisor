export const quizQuestions = [
  {
    ...
    options: [
      ...
      {
        id: "d",
        text: { en: "Art & Design", hi: "कला और डिज़ाइन" },
        stream: "arts",
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        id: "a",
        text: {
          en: "Solving puzzles/experiments",
          hi: "पहेलियां हल करना/प्रयोग",
        },
        stream: "science",
      },
      {
        id: "b",
        text: { en: "Playing business games", hi: "व्यापारिक खेल खेलना" },
        stream: "commerce",
      },
      {
        id: "c",
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "d",
        text: { en: "Helping Others", hi: "दूसरों की मदद करना" },
        stream: "arts",
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "a",
        text: { en: "Analytical Thinking", hi: "विश्लेषणात्मक सोच" },
        stream: "science",
      },
      {
        id: "d",
...
export const careerPaths = {
  science: [
    {
      step: 1,
      title: { en: "12th Science", hi: "12वीं विज्ञान" },
      description: {
        en: "Physics, Chemistry, Biology/Math",
        hi: "भौतिकी, रसायन, जीव विज्ञान/गणित",
      },
    },
    {
      step: 2,
      title: { en: "Entrance Exams", hi: "प्रवेश परीक्षा" },
      description: { en: "JEE, NEET, State CET", hi: "जेईई, नीट, राज्य सीईटी" },
    },
    {
      step: 3,
      title: { en: "Degree Course", hi: "स्नातक पाठ्यक्रम" },
      description: { en: "BTech/MBBS/BSc", hi: "बीटेक/एमबीबीएस/बीएससी" },
    },
    {
      step: 4,
      title: { en: "Career/Higher Studies", hi: "करियर/उच्च अध्ययन" },
      description: { en: "Job or Masters", hi: "नौकरी या मास्टर्स" },
    },
  ],
  commerce: [
    {
      step: 1,
      title: { en: "12th Commerce", hi: "12वीं वाणिज्य" },
      description: {
        en: "Accountancy, Economics, Business Studies",
        hi: "लेखाशास्त्र, अर्थशास्त्र, व्यापारिक अध्ययन",
      },
    },
    {
      step: 2,
      title: { en: "Professional Exams", hi: "व्यावसायिक परीक्षा" },
      description: {
        en: "CA, CS, CMA Foundation",
        hi: "सीए, सीएस, सीएमए फाउंडेशन",
      },
    },
    {
      step: 3,
      title: { en: "Degree/Articleship", hi: "स्नातक/आर्टिकलशिप" },
      description: { en: "BBA/BCom + Training", hi: "बीबीए/बीकॉम + प्रशिक्षण" },
    },
    {
      step: 4,
      title: { en: "Career Growth", hi: "करियर विकास" },
      description: { en: "Professional Practice", hi: "व्यावसायिक अभ्यास" },
    },
  ],
  arts: [
    {
      step: 1,
      title: { en: "12th Arts", hi: "12वीं कला" },
      description: {
        en: "History, Political Science, Literature",
        hi: "इतिहास, राजनीति विज्ञान, साहित्य",
      },
    },
    {
      step: 2,
      title: { en: "Competitive Exams", hi: "प्रतियोगी परीक्षा" },
      description: {
        en: "CLAT, UPSC Prelims, State PSC",
        hi: "क्लैट, यूपीएससी प्रारंभिक, राज्य पीएससी",
      },
    },
    {
      step: 3,
      title: { en: "Degree Course", hi: "स्नातक पाठ्यक्रम" },
      description: { en: "BA/LLB/BJMC", hi: "बीए/एलएलबी/बीजेएमसी" },
    },
    {
      step: 4,
      title: { en: "Career Options", hi: "करियर विकल्प" },
      description: {
        en: "Civil Services/Teaching/Media",
        hi: "सिविल सेवा/शिक्षण/मीडिया",
      },
    },
  ],
};
...
export const mockColleges = [
  {
    ...
    courses: {
      en: "Engineering, Arts, Commerce",
      hi: "इंजीनियरिंग, कला, वाणिज्य",
    },
    ranking: "Top 10",
  ...
  },
  {
    ...
    location: { en: "Delhi", hi: "दिल्ली" },
    courses: {
      en: "Social Sciences, Languages",
      hi: "सामाजिक विज्ञान, भाषाएँ",
    },
    ranking: "Top 15",
    fees: "₹30,000 - 80,000",
    website: "jnu.ac.in",
...
export const timelineEvents = [
  {
    ...
    description: {
      en: "Last date to register for JEE Main",
      hi: "जेईई मेन के लिए पंजीकरण की अंतिम तिथि",
    },
    type: "exam",
  },
  {
    ...
    description: {
      en: "NEET application deadline",
      hi: "नीट आवेदन की समय सीमा",
    },
    type: "exam",
  },
  {
    id: 3,
    title: {
      en: "DU Admission Process",
      hi: "दिल्ली विश्वविद्यालय प्रवेश प्रक्रिया",
    },
    date: "25 October 2025",
    description: {
      en: "Delhi University admission begins",
      hi: "दिल्ली विश्वविद्यालय प्रवेश शुरू",
    },
    type: "admission",
  },
  {
    ...
    description: {
      en: "Merit-based scholarship deadline",
      hi: "मेधा आधारित छात्रवृत्ति की समय सीमा",
    },
    type: "scholarship",
  },
];
