  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center">
              ...
              <div>
                <h3 className="font-semibold text-gray-800">
                  {language === 'en' ? `Class ${profile.class}` : `कक्षा ${profile.class}`}
                </h3>
          ...
          <Card variant="success">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {quizResult ? t.suggestedStream : language === 'en' ? 'Popular Choice' : 'लोकप्रिय विकल्प'}
                </p>
              </div>
            </div>
          </Card>
        ...
        {/* Nearby Government Colleges - Full Width */}
        <div className="mt-8">
          <Card title={t.nearbyColleges}>
            <p className="text-gray-600 mb-4">
              {language === 'en'
                ? 'Top government colleges near you with affordable fees and excellent facilities.'
